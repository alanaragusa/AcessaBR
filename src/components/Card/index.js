        ...
        <div className="card__container">
            ...
            <div className="card__content">
                ...
                <ul className="card__facilities">
                    <li className={`card__facilities__item ${item.facilities[0]} ${!item.facilities[0].status ? 'unchecked':''}`} >
                        <img 
                            src={iconBraile}
                    ...
                    <li className={`card__facilities__item ${item.facilities[1]} ${!item.facilities[1].status ? 'unchecked':''}`} >
                        <img 
                            src={iconAudio}
                            alt="Audio descrição"
                    ...
                    <li className={`card__facilities__item ${item.facilities[2]} ${!item.facilities[2].status ? 'unchecked':''}`} >
                        <img 
                            src={iconBanheiro}
                    ...
                    <li className={`card__facilities__item ${item.facilities[3]} ${!item.facilities[3].status ? 'unchecked':''}`} >
                        <img 
                            src={iconElevador}
                    ...
                    <li className={`card__facilities__item ${item.facilities[4]} ${!item.facilities[4].status ? 'unchecked':''}`} >
                        <img 
                    ...
                    <li className={`card__facilities__item ${item.facilities[5]} ${!item.facilities[5].status ? 'unchecked':''}`} >
                        <img 
                            src={iconCao}
                    ...
                    <li className={`card__facilities__item ${item.facilities[6]} ${!item.facilities[6].status ? 'unchecked':''}`} >
                        <img 
                            src={iconPiso}
                    ...
                    <li className={`card__facilities__item ${item.facilities[7]} ${!item.facilities[7].status ? 'unchecked':''}`} >
                        <img 
                            src={iconPorta}
                    ...
                    <li className={`card__facilities__item ${item.facilities[8]} ${!item.facilities[8].status ? 'unchecked':''}`} >
                        <img 
                            src={iconRampa}
                    ...
                    <li className={`card__facilities__item ${item.facilities[9]} ${!item.facilities[9].status ? 'unchecked':''}`} >
                        <img 
                            src={iconLibras}
